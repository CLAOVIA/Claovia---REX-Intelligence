...
export default function OnboardingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-sage-50 text-stone-600 antialiased font-sans selection:bg-sage-200 selection:text-sage-900">
      {/* Simple Header */}
      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-8 md:py-12 flex flex-col items-center">
        ...
        <div className="text-center mb-12 animate-slide-up">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-sage-900 mb-6 leading-tight">
            Transformez votre ressenti
            <br />
            en actions managériales
          </h1>
        ...
        <div className="w-full bg-white rounded-[2rem] p-8 md:p-12 shadow-xl shadow-sage-200/50 border border-sage-100 mb-16 relative overflow-hidden animate-slide-up-delay">
          {/* Background Blob */}
        ...
        {/* Values Grid */}
        <div className="grid md:grid-cols-3 gap-6 mb-16 animate-slide-up-delay-2">
        ...
        {/* The "Hook" Button - Cleaned up */}
        <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-2xl border border-stone-100 animate-slide-up-delay-3 text-center">
          ...
          <a
            ...
            className="w-full bg-sage-800 hover:bg-sage-900 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 flex items-center justify-center gap-2 text-lg group"
          >
            Commencer
          ...
          <div className="mt-6 pt-6 border-t border-stone-100 flex justify-center gap-6 text-[10px] text-stone-400 font-medium">
            <span className="flex items-center gap-1">
              <ShieldCheck className="w-3 h-3 text-green-500" /> Traitement confidentiel
            </span>
            <span className="flex items-center gap-1">
              <Lock className="w-3 h-3 text-sage-500" /> Données chiffrées
            </span>
          </div>
        </div>
      </main>
