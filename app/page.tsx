...
export default function Home() {
  return (
    <div className="relative min-h-screen bg-white text-slate-900 selection:bg-green-100 font-sans overflow-x-hidden">
      <Header />

      <main className="relative pt-32">
        <div className="relative w-full max-w-7xl mx-auto px-6 mb-20">
          <HeroBackground />
          <HeroSplit3D />
        </div>
